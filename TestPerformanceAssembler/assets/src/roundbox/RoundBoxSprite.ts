import { _decorator, ccenum, CCFloat, CCInteger, cclegacy, Component, director, InstanceMaterialType, Material, Node, NodeEventType, RenderTexture, Scene, serializeTag, Sprite, SpriteAtlas, SpriteFrame, UIRenderer, Vec2} from 'cc';
